...
### ER図
（ER図のスクリーンショットの画像）
[![Image from Gyazo](https://i.gyazo.com/26d66d436ee3125bbf6698b6bd136113.png)](https://gyazo.com/26d66d436ee3125bbf6698b6bd136113)

### 本サービスの概要（700文字以内）
筆記開示・内省支援合アプリ EmoSpace（仮）
形にならない不安や悩みを紐解くのをお手伝いするアプリ。
普段溜め込んでしまう日々の出来事で生じた感情を表現することで自分の感情を可視化し、深い自己認識・自己成長を機会得るのを支援します。
また、感情を表現したくても、言葉にできないユーザーに対しては、AIが感情整理のお手伝いをします。
会話の中で褒めることもあるが、提供するのは、気づきです。
気づきを得ることで、ユーザーの自己認識を深め、先の行動の指針に知流ことができます。
日記アプリとしても使用できます。

主な機能
・日記機能（ポスト機能）
	・出来事で生まれた感情を記録できます。
	・書き出すことで、自分がどういう視点を持つのか可視化できます。
	・加えて、AIが日記の内容を解析してユーザーに自身の思考パターンへの認識を提供します。
	・公開・非公開の設定可能
・タグ機能
　日記に紐づく感情タグを選択し保存できる。
・いいね機能
	公開された日記に対してユーザーが共感の意思表示で”いいね”ができます。
・トラッキング機能
　周期的にどういう感情を感じやすいか、どのくらいの度合いかを可視化できます。
・AI自己認識促進サポート
　不安や感情にモヤがかかってはっきりと言葉にできない場合、AIが言葉を投げかけます。
　回答することで、何に悩んでいるか、何に苦しんでいるのかを紐解いていきます。
・要約機能
　AI自己認識サポートで得られた内容を要約し、日記として記録することができます。
